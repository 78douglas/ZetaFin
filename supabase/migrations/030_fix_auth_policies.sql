...
-- Comentário
COMMENT ON TABLE users IS 'RLS temporariamente desabilitado para debug';
COMMENT ON TABLE categories IS 'RLS temporariamente desabilitado para debug';
COMMENT ON TABLE transactions IS 'RLS temporariamente desabilitado para debug';
